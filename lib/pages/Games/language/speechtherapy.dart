...
class _SpeechTherapyState extends State<SpeechTherapy> {
  ...
  @override
  void dispose() {
    // Remove Navigator.pop from dispose method
    super.dispose();
  }
  ...
  Future<void> _saveScore() async {
    ...
    try {
      ...
      if (mounted && context.mounted) {
        // Consider showing success message before navigating
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Score saved successfully!')),
        );
        // Add a slight delay to ensure the Firestore operations complete
