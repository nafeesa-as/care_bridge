...
import 'package:carebridge/pages/Games/sensory_game.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:flutter/foundation.dart';
import 'package:flutter/material.dart';
import 'GrowthMonitor/growth_monitor.dart';
      ...
      drawer: Drawer(
        child: Container(
          ...
          child: ListView(
            children: [
              DrawerHeader(
                child: Image.asset('lib/images/carebridge.jpg', height: 100),
              ),
              const SizedBox(height: 30),
              ListTile(
                leading: Image.asset('lib/images/gm.png', height: 50),
              ...
              const SizedBox(height: 30),
              ListTile(
                leading: Image.asset('lib/images/ds.png', height: 50),
              ...
              const SizedBox(height: 30),
              ListTile(
                leading: Image.asset('lib/images/game.png', height: 50),
                title: Text('Games', style: TextStyle(fontSize: 20)),
                onTap: () {
                  Navigator.of(context).push(
                    MaterialPageRoute(builder: (context) => SensoryGamePage()),
                  );
                },
              ),
              const SizedBox(height: 30),
              ListTile(
                leading: Image.asset('lib/images/cf.png', height: 50),
                    ...
                    Flexible(
                      child: SquareTile(
                        ...
                        onTap: () {
                          Navigator.of(context).push(
                            MaterialPageRoute(
                              builder: (context) => SensoryGamePage(),
                            ),
                          );
                        },
                      ),
...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> getUserData() async {
    try {
      ...
      if (userDoc.exists && userDoc.data() != null) {
        Map<String, dynamic> data = userDoc.data() as Map<String, dynamic>;
        print("User data retrieved: $data"); // Debugging
